...
const IssuesList = ({ data }) => {
    ...
    return (
        <>
            ...
            <DisplayRawdata data={fragmentData} contentDescription='raw result of useFragment() in issueslist' />
        </>
    );
}
...
const IssueRow = ({ data }) => {
    ...
    return (
        <>
            ...
            <DisplayRawdata data={fragmentData} contentDescription='raw result of useFragment() in IssueRow' />
        </>
    );
