...
export type IssueCommentsPaginationQueryVariables = {|
  count?: ?number,
  cursor?: ?string,
  id: string,
|};
export type IssueCommentsPaginationQueryResponse = {|
  +node: ?{|
    +$fragmentRefs: IssueComments_issue$ref
  |}
|};
export type IssueCommentsPaginationQuery = {|
  variables: IssueCommentsPaginationQueryVariables,
  response: IssueCommentsPaginationQueryResponse,
|};
*/


/*
query IssueCommentsPaginationQuery(
  $count: Int = 10
  $cursor: String
  $id: ID!
) {
...
fragment IssueComments_issue_1G22uz on Issue {
  comments(first: $count, orderBy: {field: UPDATED_AT, direction: ASC}, after: $cursor) {
    edges {
      cursor
      node {
        author {
...
return {
  ...
  "params": {
    "cacheID": "3900c472be61456aad3c26bccb559794",
    "id": null,
    "metadata": {},
    "name": "IssueCommentsPaginationQuery",
    "operationKind": "query",
